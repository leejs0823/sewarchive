...
| 함께 자라기 |
| 프런트엔드 성능 최적화 가이드 |
| 피그마 스타터: 처음부터 차근차근 배우는 UI UX 디자인 |
| UX/UI 디자인 완벽 가이드: UI, 인터랙션, 프로토타이핑 편 |
| 실전 피그마 |
| 화이트 해커를 위한 웹 해킹의 기술 |
| 파이썬 해킹 레시피 |
...
수령 방법: '보안/웹 책 대여하러 왔다' 라고 근로자에게 전달한 뒤, 책을 찾아달라고 하고 수기 명부 작성하되 + github에 안내된대로 트랙 내 관리를 위해 리드미 명부를 추가적으로 작성해야 합니다!
...
- 수령 장소: 신공학관 3137 (테스트베드)
- 수령 시간: 10:00 ~ 17:00 (=근로자 상주 시간)
- 수령 방법: '보안/웹 책 대여하러 왔다' 라고 근로자에게 전달한 뒤, 책을 찾아달라고 하고 수기 명부 작성하되 + github에 안내된대로 트랙 내 관리를 위해 리드미 명부를 추가적으로 작성해야 합니다! (리드미 맨 아래에 있어요!💚)
